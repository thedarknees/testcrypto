...
MAIN_TEXT = """📲 Набираем трафферов в команду <b>OF Traffic Insider</b> как с опытом, так и без!

<blockquote>Предоставляем бесплатное обучение и работаем с такими направлениями как:
...
<blockquote>- Совершеннолетие (строго 18+)</blockquote>

<blockquote>- Наличие доп. устройства под работу (любой андроид, айфон, помимо личного, либо пк/ноут)</blockquote>

<blockquote>- Свободные 4-6ч в день.</blockquote>
...
<blockquote>Основной задачей специалиста в этой сфере, является ведение аккаунтов в соц.сетях и перелив аудитории от туда на страницы моделей.</blockquote>
...
<blockquote>Заработок полностью зависит от вашей трудоспособности, готовности к риску и несению ответственности за свои действия.</blockquote>
...
<blockquote>Работа полностью удалённая, график свободный, так что вы сами влияете на результативность, мы помогаем всем чем можем! 🤝</blockquote>"""
...
def main_menu_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="🧢 О работе", callback_data="about")],
