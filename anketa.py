...
MAIN_TEXT = """🚀 <b>Набор баеров под УБТ-трафик</b>

Ищем баеров в команду. Обучаем с нуля — опыт не обязателен.

<b>Работаем с источниками:</b>
• TikTok
• Instagram
• Threads
• X (Twitter)
...
<b>Что предлагаем:</b>
✅ Обучение с нуля
✅ Прозрачная статистика и выплаты раз в неделю
✅ Оплата за Free и Paid-подписчиков
✅ Новые креативы и модели каждую неделю
✅ Возможность вырасти до Team Lead или Owner

Уже более <b>400+ трафферов</b> работают с нами.

Оставляйте заявку — вся информация по условиям внутри 👇"""

ABOUT_TEXT = """🧑‍💻 <b>О позиции: баер под УБТ</b>

УБТ — условно-бесплатный трафик. Вы ведёте аккаунты в соцсетях и приводите подписчиков на страницы моделей.

<b>Чем предстоит заниматься:</b>
• вести аккаунты и заливать контент
• тестировать связки и форматы, находить рабочие
• масштабировать то, что даёт результат
• следить за статистикой

<b>Источники:</b>
TikTok, Instagram, Threads, X (Twitter), YouTube, Reddit

<b>Что даём:</b>
• обучение с нуля, опыт не обязателен
• новые креативы и модели каждую неделю
• поддержку на всех этапах

Работа удалённая, график свободный."""
...
<b>Нужен ли опыт?</b>
Нет. Обучаем с нуля, берём новичков.

<b>Нужны вложения?</b>
Нет. Свой бюджет не нужен, креативы и модели даём мы.

<b>Как считается оплата?</b>
За Free и Paid-подписчиков. Статистика открытая, потолка нет.

<b>Когда выплаты?</b>
Раз в неделю.

<b>Что нужно для старта?</b>
Телефон или компьютер и желание работать.

<b>Как проходит отбор?</b>
Заявка → короткое интервью в Telegram → старт обучения."""
